...
2. redis是单线程还是多线程？
   ...
   *，客户端被读取的顺序不能被保障
   ...
   ![image-20210401102201692](05_Redis_MT.assets/image-20210401102201692.png)
...
6. 如何避免缓存雪崩？
   ...
   ![image-20210401102828490](05_Redis_MT.assets/image-20210401102828490.png)
...
16. redis中的事务三条指令式什么，第三条指令到达后执行失败了，怎么处理
    ...
    ![image-20210401103038104](05_Redis_MT.assets/image-20210401103038104.png)
